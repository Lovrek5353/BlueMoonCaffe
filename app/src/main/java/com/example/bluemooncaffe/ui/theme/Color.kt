...
val darkBackgroud = Color( 252525 )
val darkPrimary = Color(0xFFFF4081)
val darkSecondary = Color (0xFFE91E63)
val darkAccent = Color( 0xFFFF5252)
val darkText = Color (0xFFFFFFFF)
val darSubdueText= Color(0xFFB3B3B3)
val darkDisabledText= Color(0xFF808080)
val darkSeparator= Color(0xFF404040)
val darkButton=Color(0xFFFF4081)
...
val onSurface = Color(0xFFFFAB91)
val error = Color(0xFFFF5722)

val lightPrimary = Color(0xFFFFEB3B)
val lightPrimaryVariant = Color(0xFFFFC107)
val lightSecondary = Color(0xFFFF9800)
val lightSecondaryVariant = Color(0xFFFF5722)
val lightBackground = Color(0xFFE0F2F1)
